        ...
        for item_node in item_node_list:
            ...
            for place_node in place_node_list:
                ...
                for place_platform in platform_list:
                    ...
                    if len(available_directions) == 0 and place_platform.name not in ['objects/RoboTHOR_hemnes_day_bed_0','objects/RoboTHOR_hemnes_day_bed_1','objects/RoboTHOR_hemnes_day_bed_2']:
                        continue
                    available_directions = available_directions[:1] if len(available_directions) else [0]
